          ...
          {searchResult ? (
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className={`inline-flex items-center space-x-2 px-3 py-1 rounded-full border ${getStatusColor(searchResult.statut)}`}>
                      ...
                      <span className="font-medium">{searchResult.statut}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-sm text-gray-500">Expéditeur:</span>
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-gray-900">Détails</h4>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <Calendar className="h-4 w-4 text-gray-400" />
                      <div>
                        <span className="text-sm text-gray-500">Expédition:</span>
                        <div className="font-medium">{searchResult.expedition}</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Calendar className="h-4 w-4 text-gray-400" />
                      <div>
                        ...
                        <div className="font-medium">{searchResult.livraisonPrevue}</div>
                      </div>
                    </div>
                    {searchResult.livraisonEffective && (
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <span className="text-sm text-gray-500">Livraison effective:</span>
                          <div className="font-medium">{searchResult.livraisonEffective}</div>
                        </div>
                      </div>
                    )}
              ...
              {/* Suivi étapes */}
              <div className="space-y-4">
                <h4 className="text-lg font-semibold text-gray-900">Suivi de livraison</h4>
                <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {mockPackages.map((pkg) => (
            <button
              ...
              className="px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-md text-sm font-mono transition-colors duration-200"
            >
              {pkg.numero}
            </button>
          ))}
